...
public interface JobRepository extends JpaRepository<JobEntity, Integer> {
    ...
    @Query(value="SELECT u.id, j.id, j.title, j.user_id, j.description, j.category_id, j.salary, j.latitude, j.longitude, j.applyer_id, j.is_done, u.firebase_token from jobs j " +
