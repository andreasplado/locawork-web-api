...
public interface JobRepository extends JpaRepository<JobEntity, Integer> {
    ...
    List<JobEntity> findNearestJobs(@Param("latitude") Double latitude, @Param("longitude") Double longitude, @Param("distance") Double distance, @Param("email") String email);
