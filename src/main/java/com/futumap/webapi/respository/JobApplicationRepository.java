...
public interface JobApplicationRepository extends JpaRepository<JobApplicationEntity, Integer> {
    ...
    @Query(value="SELECT new com.futumap.webapi.dto.JobApplicationDTO(ja.id, ja.is_approved, j.title, j.description, j.salary, ja.created_at, ja.updated_at) FROM job_applications ja" +
